...
import { WeeklyEvidenceComponent } from './weekly-evidence/weekly-evidence.component';
...
@NgModule({
  declarations: [
    ...
    HelpComponent,
    HomeComponent,
    BeehiveDialogComponent,
    EquipmentDialogComponent,
    BeehiveEvidenceDialogComponent,
    WeeklyEvidenceComponent,
